...
const baseQuery = customBaseQuery("product")
...
export const productApi = createApi({
    ...
    endpoints: (builder) => {
        return {
            getProducts: builder.query<{ result: IProduct[], pagination: IPagination }, Partial<{ page: number, limit: number, searchQuery: string, isFetchAll: boolean, category: string }>>({
                query: (queryParams = {}) => {
                    return {
                        url: "/",
                        method: "GET",
