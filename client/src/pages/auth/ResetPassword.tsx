...
import { Container, Paper, Typography, Button, Box, FormControl, InputLabel, OutlinedInput, InputAdornment, IconButton, } from "@mui/material";
            ...
            <Paper elevation={3} sx={{ padding: 4, width: "100%", textAlign: "center" }}>
                ...
                <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ mt: 1 }}>
                    ...
                    <Button
                        ...
                        variant="contained"
                        color="primary"
                        sx={{ my: 2, backgroundColor: "#0F766E", color: "white" }}
                    >
                        Reset Password
                    </Button>
                </Box>
