...
const Profile = () => {
    ...
    return <>
        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ display: "flex", justifyContent: "center", mt: 4, px: { sm: 6, md: 10, lg: 48, xl: 64 } }}>
                        ...
                        isEditing
                            ? <Box sx={{ textAlign: "end", mt: 4 }}>
                                ...
                                <Button
                                    ...
                                    variant="contained"
                                    startIcon={<SaveIcon />}
                                    sx={{ backgroundColor: "#0F766E", color: "white", ml: 2 }}
                                    type="submit"
                                >
                                    Save
                                </Button>
                            ...
                            : <Button
                                variant="contained"
                                startIcon={<EditIcon />}
                                sx={{ mt: 2, backgroundColor: "#0F766E", color: "white", '&:hover': { bgcolor: 'darkcyan' } }}
                                type="button"
